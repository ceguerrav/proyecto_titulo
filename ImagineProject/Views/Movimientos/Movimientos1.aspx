...
<fieldset>
    <legend>Movimientos en Tiempo Real</legend>
        ...
        <p>
            <input type="button" value="Mostrar" id="btn_mostrar" class="btn btn-default" onclick="javascript:buscarAjax();"/>
        </p>
