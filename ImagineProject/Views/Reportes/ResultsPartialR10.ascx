<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<IEnumerable<ImagineProject.Models.Reporte10>>" %>
...
<% foreach (var item in Model) { %>
    <tr>
        ...
        <td>
            <%: Html.DisplayFor(modelItem => item.Cantidad_Viaje) %>
        </td>
        <td>
            <%: Html.DisplayFor(modelItem => item.Puerto_Destino) %>
        </td>
        <td>
