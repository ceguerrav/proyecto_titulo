<%@ Control Language="C#" 
Inherits="System.Web.Mvc.ViewUserControl<IEnumerable<ImagineProject.Models.Reporte5>>" %>
...
<% foreach (var item in Model) { %>
    <tr>
        ...
        <td>
            <%: Html.DisplayFor(modelItem => item.TipoRecinto) %>
        </td>
        <td>
        ...
        <td>
            <%: Html.DisplayFor(modelItem => item.MinMov) %>
        </td>
        <td>
            <%: Html.DisplayFor(modelItem => item.MaxMov) %>
        </td>
    </tr>
<% } %>
    </tbody>
...
<div>
    <img src="/Reportes/GetGraficoRep5" />
</div>